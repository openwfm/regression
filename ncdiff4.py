            ...
            for var_name, variable in dataset1.variables.items():
                ...
                if var_name in dataset2.variables:
                    ...
                    if var1.shape[1:] == var2.shape[1:]:
                        ...
                        rel_diff_max = abs(max_norm1 - max_norm2) / max(max_norm1, max_norm2, np.finfo(float).eps)
                        rel_diff_two = abs(two_norm1 - two_norm2) / max(two_norm1, two_norm2, np.finfo(float).eps)
